...
public class PaketeConfig
{
    ...
    public static void createCustomConfig() {
        customConfigFile = new File(Main.getInstance().getDataFolder().getAbsolutePath() + "/pakete.yml");
    ...
    {
        return Main.getInstance().getDataFolder().getAbsolutePath() + "/pakete.yml";
    }
}
